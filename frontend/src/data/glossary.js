export const GLOSSARY_ENTRIES = [
  {
    ...
    definition: (term) => [
      "Un Beat es un evento o señal de salud autenticada: un mensaje que emite un ",
      term("system", "System"),
      ", firmado con JWT y clasificado por un tipo de Beat. El ",
      term("operator", "Operator"),
      " lo ve en su panel y, cuando aplica, es el origen de una notificación en ",
  ...
  },
  {
    ...
    definition: (term) => [
      "El Hub es el centro que se vende a cada empresa para controlar la salud de sus ",
      term("system", "Systems"),
      ". Desde ahí se dan de alta ",
      term("operator", "Operators"),
      ", ",
      term("system", "Systems"),
      " (con ",
      term("jwt", "JWT"),
      ") y tipos de ",
      term("beat", "Beat"),
      "; también se validan, persisten y enrutan los ",
      term("beat", "Beats"),
      " de esa empresa.",
    ],
  },
  {
    id: "jwt",
    term: "JWT",
    fullName: "Credencial del System",
    definition:
      "JWT es la credencial con la que un System se autentica ante el Hub al enviar Beats. Cada System se registra en el Hub de su empresa y obtiene esa credencial. Hub no acepta Beats anónimos.",
  },
  {
    id: "monitor",
    term: "Monitor",
